...
class SensorData(JsonifiableBase, BaseTable):
    ...
    sensor_type_id = Column("sensor_type_id", Integer,
...
Farm.sensor_data = relationship(
    "SensorData", order_by="desc(SensorData.date)", back_populates="farm")
SensorType.sensor_data = relationship(
    "SensorData", order_by="desc(SensorData.date)", back_populates="sensor_type")
